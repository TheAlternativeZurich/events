 ...
 */
final class Version20201002161209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_AB55E24F833D8F43');
        $this->addSql('DROP INDEX IDX_AB55E24F71F7E88B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__participation AS SELECT id, event_id, registration_id, join_date, leave_date, created_at, last_changed_at, given_name, family_name, phone, email, street_address, postal_code, locality, canton, country FROM participation');
        ...
        , join_date DATETIME NOT NULL, leave_date DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, given_name CLOB NOT NULL COLLATE BINARY, family_name CLOB NOT NULL COLLATE BINARY, phone CLOB NOT NULL COLLATE BINARY, email CLOB NOT NULL COLLATE BINARY, street_address CLOB NOT NULL COLLATE BINARY, postal_code INTEGER NOT NULL, locality CLOB NOT NULL COLLATE BINARY, canton VARCHAR(255) DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_AB55E24F71F7E88B FOREIGN KEY (event_id) REFERENCES event (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_AB55E24F833D8F43 FOREIGN KEY (registration_id) REFERENCES registration (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO participation (id, event_id, registration_id, join_date, leave_date, created_at, last_changed_at, given_name, family_name, phone, email, street_address, postal_code, locality, canton, country) SELECT id, event_id, registration_id, join_date, leave_date, created_at, last_changed_at, given_name, family_name, phone, email, street_address, postal_code, locality, canton, country FROM __temp__participation');
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN is_email_confirmed BOOLEAN DEFAULT \'0\' NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_62A8A7A771F7E88B ON registration (event_id)');
        $this->addSql('CREATE INDEX IDX_62A8A7A7A76ED395 ON registration (user_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, authentication_hash, is_admin_account, created_at, last_changed_at, given_name, family_name, phone, email, street_address, postal_code, locality, canton, country FROM user');
        ...
        $this->addSql('INSERT INTO user (id, authentication_hash, is_admin_account, created_at, last_changed_at, given_name, family_name, phone, email, street_address, postal_code, locality, canton, country) SELECT id, authentication_hash, is_admin_account, created_at, last_changed_at, given_name, family_name, phone, email, street_address, postal_code, locality, canton, country FROM __temp__user');
